              ...
              <>
                <div>
                  <div>
                    <ProfileMetric
                      label={'net worth'}
                      value={`${formatNumberWithCommas(netWorthTemple)} TEMPLE`}
                  ...
                  <div>
                    <ProfileMetric
                      ...
                      value={`${formatNumberWithCommas(stakedTemple)} TEMPLE`}
                      detail={`$${formatNumberWithCommas(stakedTempleValue)} (${
                        accountMetrics?.templeApy
                      }% APY)`}
                    />
                  </div>
                  <div>
                    <ProfileMetric
                      label={`Staked & Locked`}
                      value={`${formatNumberWithCommas(lockedTemple)} TEMPLE`}
                      detail={`$${formatNumberWithCommas(lockedTempleValue)} (${
                        accountMetrics?.templeApy
                      }% APY)`}
                    />
                  </div>
