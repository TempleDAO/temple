...
contract TempleFraxAMMRouter is Ownable, AccessControl {
    ...
    function swapExactFraxForTemple(
        ...
        if (thresholdPriceTemple * reserveFrax >= thresholdPriceFrax * reserveTemple) {
            ...
            uint newDynamicThresholdPricetemple = reserveTemple * dynamicThresholdPrice.frax * DYNAMIC_THRESHOLD_INCREASE_DENOMINATOR / (reserveFrax * dynamicThresholdIncreasePct);
