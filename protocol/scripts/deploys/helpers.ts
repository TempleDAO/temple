...
export const DEPLOYED_CONTRACTS: { [key: string]: DeployedContracts } = {
  ...
  mainnet: {
    ...
    // RAMOS
    RAMOS: '0x40F30803DA042928C88c3bd73806b6125C417a96',
    RAMOS_POOL_HELPER: '0xe273120e0Ba4ad2B8e2e9291b2e951Bc733a3F4d',
    RAMOS_AURA_STAKING: '0x0FB80EDE24a16c3496290eDC3f7Fa723378B669a',
    ...
    TEMPLE_BB_A_USD_AURA_STAKING_DEPOSIT_TOKEN:
      '0x058141Ca1097b8D76Ac87aAf012FCB0C088fcBd3',
  },
  localhost: {
