...
interface TeamPayments {
  ...
  TEMPLE_TEAM_EPOCH_28C: string;
  TEMPLE_TEAM_EPOCH_29A: string;
  TEMPLE_TEAM_EPOCH_29B: string;
  TEMPLE_TEAM_EPOCH_29C: string;
  TEMPLE_TEAM_EPOCH_30A: string;
  TEMPLE_TEAM_EPOCH_30B: string;
  TEMPLE_TEAM_EPOCH_30C: string;
  TEMPLE_TEAM_EPOCH_31A: string;
  TEMPLE_TEAM_EPOCH_31B: string;
  TEMPLE_TEAM_EPOCH_31C: string;
  TEMPLE_TEAM_EPOCH_32A: string;
  TEMPLE_TEAM_EPOCH_32B: string;
  TEMPLE_TEAM_EPOCH_32C: string;
  TEMPLE_TEAM_EPOCH_33A: string;
  TEMPLE_TEAM_EPOCH_33B: string;
}
...
export const DEPLOYED_CONTRACTS: { [key: string]: DeployedContracts } = {
  ...
  mainnet: {
    ...
    TEAM_PAYMENTS: {
      ...
      TEMPLE_TEAM_EPOCH_28C: '0x98DE4F694D1471a7eDFd979B990D787C1C39747d',
      TEMPLE_TEAM_EPOCH_29A: '0xc5Db76bE904f73BA3094a43D7012d43e24768Ce0',
      TEMPLE_TEAM_EPOCH_29B: '0x8E6FE89bD760EED6045aDEE742253369453B1956',
      TEMPLE_TEAM_EPOCH_29C: '0xb1A0434c8d542E286d6941Bb17290272E4Ca47Bd',
      TEMPLE_TEAM_EPOCH_30A: '0xD7c7e600dC8D55c274d04d337A3b3F0D54886C71',
      TEMPLE_TEAM_EPOCH_30B: '0x492F6B720B40DC2c82Acaf8e884945986D6676aC',
      TEMPLE_TEAM_EPOCH_30C: '0x7d3c5C9C0143c44399709B6Cee09d001E859Dd1C',
      TEMPLE_TEAM_EPOCH_31A: '0xd7ede7adA00e37BA6038C5f8C10dc187d264a880',
      TEMPLE_TEAM_EPOCH_31B: '0xB8BDe97160B8518848eFf0D454a51f61b69EF8e9',
      TEMPLE_TEAM_EPOCH_31C: '0x512C330ced09ef2856cc9554F9A1E9C7efD40746',
      TEMPLE_TEAM_EPOCH_32A: '0xddD35F79327133e6289dbecBCAD491EFbF663374',
      TEMPLE_TEAM_EPOCH_32B: '0x0454c2c713A191B03c96f902C5c91FFF81311962',
      TEMPLE_TEAM_EPOCH_32C: '0x9F5695c16e6d29E653e14DeE2AB94f4D0140ad3e',
      TEMPLE_TEAM_EPOCH_33A: '0x5e4A42DaEd8D4986d23E22CFA18775a26A68d69F',
      TEMPLE_TEAM_EPOCH_33B: '0x9dAd51245e4E7B9f2Ed4C8e288ca8dEDbc520c9e',
    },
