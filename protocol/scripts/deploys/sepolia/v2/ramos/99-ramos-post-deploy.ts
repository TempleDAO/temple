...
import { ITempleStrategy, Ramos, RamosTestnetAuraStaking } from "../../../../../typechain";
...
async function stakingPostDeploy(auraStaking: RamosTestnetAuraStaking, TEMPLE_V2_ADDRESSES: ContractAddresses) {
    ...
    // Not in the Testnet version of Aura Staking
    {
        ...
        //     parseInt(TEMPLE_V2_ADDRESSES.DEPLOYED.TEMPLE_DAI_AURA_POOL_ID), 
