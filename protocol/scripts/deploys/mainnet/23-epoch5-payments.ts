...
async function main() {
  ...
  const templeTeamPayments: TempleTeamPayments = await deployAndMine(
    'TEMPLE_TEAM_EPOCH_5',
    templeTeamPaymentsFactory,
    templeTeamPaymentsFactory.deploy,
    DEPLOYED.TEMPLE,
  ...
  const allocs: { [address: string]: number } = {
    ...
    '0xA1D0Ff488595Eb262c086A344421a43717F8fCAF': 2345,
    '0xF9B4De4bB735ACE677813ac8E24B6530B2D595E9': 7956,
    '0x072d76b501E364FCA58B6A7fe16a88c74D64924c': 3978,
    '0xF94A14fdEbf75007329E50f0aC9f459fF566B157': 6415,
    '0x228900C0263B6Ac19E66fF491E30c83d3473a2d8': 9013,
    ...
    '0x54120e6f4379A525AcC5aE7DBbf6758c271b8b15': 59364,
    '0xbbbEd1aC44706Cf8E82788a1Eda98418981Eb798': 4277,
    '0x4e51F68940FaC327B2f018B6b79109031031fe8b': 12830,
    '0x3AC87eD1BEDB341f97656d5f24EDDEf7Fc810811': 46488,
    '0x0D44463bfB16A7Af95D8D873b7233Efe247816cd': 25175,
    '0xA0483f29E325108A34c2A385c999C2FeF08d4Af7': 9622,
    '0x2acfd61F1ccbE5F8fF1fF34a6eC2958685b8Fc89': 29203,
    '0x248e5c90143E6E283E5c45387b10D91049C390c8': 3207,
    '0x5245859F78bb510aB9c8A4Ce74506Ec1F7D24DD3': 55088,
    '0xe5D74520A77EDaa6Fff050975775213FA01948c9': 110176,
    '0xfED4FEd3C90C4e93D203D25EF2B148C863b68356': 90630,
    '0x588282ADA5B9D872d0eBF506c5C1b541e2a60BBa': 41555,
    '0x389E3d1c46595aF7335F8C6D3e403ce2E8a9cf8A': 1069,
    '0x542aAF07235D8c01589C9A87D0871aB990272C33': 110176,
    '0x0c9C3Ba64072eb566b0E9A4B6Bb0D7B204d68469': 1069,
    '0x0F511FE5Dcdb54b0b19A5A2a57E76977Ae728C15': 8056,
    '0xF2E1A88af3D6cDdD60B9c43CeE53d655cBa40b2c': 5936,
    '0x27E9578BD639A2876636A0DDEfFeb7bd4b539003': 3978,
    '0x06e6F9DE62afa6F2Ca092Fe17fF57dAc3Ae30db1': 38266,
    '0x7f068d2890bD5ce602DCB9d040515306d067cA02': 34562,
    '0x73E29Bb563592610a4DdDfbeEFC0259E3A27e410': 6415,
    '0x387a652c87A2571b93EF4dECc61BEB74A5970582': 13899,
    '0x294A29Ad8842E7234EE16B1b16f1F98747B715Eb': 3207,
    '0x3f0e5DbC6093E8773F14f0186FFE32F733C34ef7': 4277,
    '0xDCeC3b61fFB8b946A5c07129F3855adDc7077ad6': 2144,
    '0x7DaE5d7aA1abb5EcFA8BE12D0C5E9A84F0e5C7CA': 2138,
    '0xDC884904D07d201c54D1aa5D0AD509E4eE289eAe': 4277,
    '0xF225d51037eBcC32B3347184A89a10F1FF3e58df': 17809,
    '0x5623fE10b48B8455e4573F0D80EfD7E60C10559D': 4277,
    '0x628Cd2FB44514dCF2Ef73B6C5D3DBb2c1b972071': 59364,
    '0x779731032c24356199a7baaFae20f4271c0Ccc80': 38864,
    ...
    '0x5a71Db7011bE6452CE46bEb8b14e9bdBA0F781Cb': 14194,
    '0x056c7b90255cA73EF674F75d9653bB5d947c4C9E': 4277,
  };

  await mine(
    templeTeamPayments.setAllocations(
      Object.keys(allocs),
      Object.values(allocs).map((a) => toAtto(a))
    )
  );

  await mine(templeTeamPayments.transferOwnership(DEPLOYED.MULTISIG));
}
