...
pragma solidity >=0.7.0 <0.9.0;
    ...
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•..˚•´.°:°•.°+.*•´.*:*/
    /* A direct copy of Safe v1.3 - except isValidSignature() params memory rather than calldata      */
    /*                          to compile for later versions of solc                                 */
    /* https://github.com/safe-global/safe-contracts/blob/v1.3.0/contracts/handler/CompatibilityFallbackHandler.sol
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
