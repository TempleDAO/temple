...
contract TestnetShard is ERC1155, ERC1155Burnable {
    ...
    /// @notice operators for testnet only
    ...
    function setPartnerAllowedShardId(address partner, uint256 shardId, bool allow) external onlyOperator {
    ...
    function setRecipe(uint256 recipeId, Recipe calldata recipe) external onlyOperator {
