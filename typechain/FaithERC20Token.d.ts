...
interface FaithERC20TokenInterface extends ethers.utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "addMinter(address)": FunctionFragment;
    "addWhiteListForTransfer(address)": FunctionFragment;
    ...
    "removeWhiteListForTransfer(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "addWhiteListForTransfer",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removeWhiteListForTransfer",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class FaithERC20Token extends BaseContract {
  ...
  interface: FaithERC20TokenInterface;
