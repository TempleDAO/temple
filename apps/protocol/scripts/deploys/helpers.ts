...
export const DEPLOYED_CONTRACTS: {[key: string]: DeployedContracts} = {
  ...
  mainnet: {
    ...
    FAITH_AIRDROP: '0x9419308970A2E5DBEC444DCEA7e1FCCD5bE4e44C',
    LOCKED_OG_TEMPLE: '0x8b0861bC6d4BfcC8dc1e0D387CCeF56324c911ef',
    DEVOTION: '0x092AB6f1F08120E43b5643CeC66a091AFeaFaCd2',
  },
  localhost: {
    // No longer active/unused
