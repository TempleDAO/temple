...
export interface LockedOGTempleDeprecatedInterface extends utils.Interface {
  contractName: "LockedOGTempleDeprecated";
  functions: {
...
export interface LockedOGTempleDeprecated extends BaseContract {
  contractName: "LockedOGTempleDeprecated";
