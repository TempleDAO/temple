...
export interface Shards extends BaseContract {
  ...
  functions: {
    ...
    partnerMinters(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    partnerMinters(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
