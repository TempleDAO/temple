...
export declare namespace TempleFraxAMMRouter {
...
export interface TempleFraxAMMRouterInterface extends utils.Interface {
  contractName: "TempleFraxAMMRouter";
  functions: {
...
export type DynamicThresholdChangeEvent = TypedEvent<
  [BigNumber],
  { currDynamicThresholdTemple: BigNumber }
>;

export type DynamicThresholdChangeEventFilter =
  TypedEventFilter<DynamicThresholdChangeEvent>;
...
export type PriceCrossedBelowDynamicThresholdEventFilter =
  TypedEventFilter<PriceCrossedBelowDynamicThresholdEvent>;
...
export interface TempleFraxAMMRouter extends BaseContract {
  contractName: "TempleFraxAMMRouter";
  ...
  filters: {
    ...
    ): DynamicThresholdChangeEventFilter;
    ...
    "PriceCrossedBelowDynamicThreshold(uint256)"(
      blockNumber?: null
    ): PriceCrossedBelowDynamicThresholdEventFilter;
