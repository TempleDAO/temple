...
export declare namespace OpeningCeremony {
...
export interface OpeningCeremonyInterface extends utils.Interface {
  contractName: "OpeningCeremony";
  functions: {
...
export type MintCompleteEventFilter = TypedEventFilter<MintCompleteEvent>;
...
export type StakeCompleteEventFilter = TypedEventFilter<StakeCompleteEvent>;
...
export type VerifiedUserAddedEventFilter =
  TypedEventFilter<VerifiedUserAddedEvent>;

export interface OpeningCeremony extends BaseContract {
  contractName: "OpeningCeremony";
  ...
  filters: {
    ...
    "VerifiedUserAdded(address)"(user?: null): VerifiedUserAddedEventFilter;
    VerifiedUserAdded(user?: null): VerifiedUserAddedEventFilter;
  };
