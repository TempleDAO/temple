...
export interface RebasingERC20Interface extends utils.Interface {
  contractName: "RebasingERC20";
  functions: {
...
export interface RebasingERC20 extends BaseContract {
  contractName: "RebasingERC20";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RebasingERC20Interface;
