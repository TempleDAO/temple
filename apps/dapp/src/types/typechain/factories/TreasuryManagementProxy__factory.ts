...
type TreasuryManagementProxyConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TreasuryManagementProxyConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TreasuryManagementProxy__factory extends ContractFactory {
  constructor(...args: TreasuryManagementProxyConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "TreasuryManagementProxy";
  }
  ...
  static readonly contractName: "TreasuryManagementProxy";
  public readonly contractName: "TreasuryManagementProxy";
