...
const VaultClaim = () => {
  ...
  return (
    <>
      <h2 className={'margin-remove'}>Enter Vault</h2>
      <br />
      <small className={'color-brandLight'}>
        DEPOSIT {TICKER_SYMBOL.TEMPLE_TOKEN} TO ENTER VAULT{' '}
      </small>
      <br />
      <br />
      <Input
      ...
      />
      <InputDescription>1.1x Multiplier on Temple Staked</InputDescription>
      <br />
      <br />
