      ...
      <BodyContainer>
        <ContainerTop>
          <Header>
            ...
            <HeaderText>
              Staking TEMPLE tokens boosts your TGLD {!isPhoneOrAbove && <br />}
              rewards over time—25% after 4 weeks, {!isPhoneOrAbove && <br />}
              50% after 6 weeks, and full rewards after{' '}
              {!isPhoneOrAbove && <br />}
              12 weeks. Each stake is independent, so{' '}
              {!isPhoneOrAbove && <br />}
              reward rates vary based on individual {!isPhoneOrAbove && <br />}
              vesting schedules.
            </HeaderText>
          </Header>
          <StatusContainer>
              ...
              <Box>
                {stakePageMetricsLoading ? (
                  ...
                  <>
                    ...
                    <Title>Total Staked (TEMPLE)</Title>
                  </>
                )}
              </Box>
              <Box>
