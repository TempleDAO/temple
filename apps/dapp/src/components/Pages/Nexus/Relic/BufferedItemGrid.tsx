...
const BufferedItemGrid: FC<{
  ...
  return <>
    <ItemGrid items={unselectedItems} disabled={disabled || processing}
    ...
    { (selectedItems.length > 0) && 
        <BufferPanel items={selectedItems} disabled={disabled || processing}
...
const BufferPanel: FC<{
  ...
  return (
    <NexusPanel style={{
      ...
      />
      <NexusPanelRow>
        <Button isSmall disabled={disabled}
          label="Cancel"
