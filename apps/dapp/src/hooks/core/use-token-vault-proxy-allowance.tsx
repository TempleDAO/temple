...
export const useTokenVaultProxyAllowance = (ticker: TICKER_SYMBOL = TICKER_SYMBOL.TEMPLE_TOKEN): HookReturnType => {
  ...
  const getTokenAllowance = async () => {
    ...
    const vault = new VaultProxy__factory(signer).attach(env.contracts.vaultProxy);
