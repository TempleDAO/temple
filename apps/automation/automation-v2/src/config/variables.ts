...
export const sepolia_t0_max_priority_fee_per_gas = new BigRationalVariable({
...
export const sepolia_t1_max_priority_fee_per_gas = new BigRationalVariable({
...
export const sepolia_t2_max_priority_fee_per_gas = new BigRationalVariable({
