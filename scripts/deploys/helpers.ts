...
export const DEPLOYED_CONTRACTS: {[key: string]: DeployedContracts} = {
  rinkeby: {
    ...
    // new exit queue. needs to be wired up with staking contract before it can be used
    // EXIT_QUEUE: '0xB9167A58f0c76AD368FE5842A014394738668041',
    ...
    TREASURY_MANAGEMENT: '0xBc81652E40789e55716FC7eeB53ee28f1C682F6c',
    ...
    TEMPLE_V2_PAIR: '0x7dd4b58F03FEaba7f8e91c280E7F84819f1efB95',
    TEMPLE_V2_ROUTER: '0x1851Fd15a9D45983581580fFf1C1cD7a0C497C80',
